document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveProductData(productData, isEditing) {
        if (isEditing) {
            ...
            addProductForm.querySelector('button').innerHTML = '<i class="fas fa-save"></i> Guardar Producto';
    ...
    function updateTotalItems(count) {
        ...
        totalItemsElement.textContent = `Mostrando ${total} ${total === 1 ? 'producto' : 'productos'}`;
    }
